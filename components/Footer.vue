<template>
    <div class="vfooter">
        ...
        <a title="GitHub" href="https://github.com/Ice-Hazymoon/实用工具" target="_blank" rel="noopener noreferrer">
            <svg class="icon" aria-hidden="true">
                <use xlink:href="#icon-github" />
            </svg>
        </a>
        
        <a title="Telegram" href="https://t.me/实用工具" target="_blank" rel="noopener noreferrer">
            <svg class="icon" aria-hidden="true">
